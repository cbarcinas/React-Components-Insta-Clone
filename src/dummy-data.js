const dummyData = [
  ...
  },
  {
    ...
    thumbnailUrl:
      "https://icon2.cleanpng.com/20180320/sqe/kisspng-twitch-computer-icons-streaming-media-youtube-live-tv-twitch-icon-5ab19172461392.001176751521586546287.jpg",
    imageUrl:
      "https://images.unsplash.com/photo-1506076177893-89d54794ef41?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=634&q=80",
    likes: 2,
    timestamp: "January 4th 1994 , 03:12:09 pm",
    comments: [
      {
        id: 40,
        username: "test",
        text: "Whoa, it's a goat",
      },
      {
        id: 41,
      ...
      },
      {
        id: 43,
        username: "hoi_671",
        text: "how we do that, why he so cool",
      },
    ],
  },
];
